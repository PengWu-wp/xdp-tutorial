...
static void handle_receive_packets(struct xsk_socket_info *xsk)
{
	...
	if (!rcvd)
		return;
//	printf("	收到包！当前各RING的状态：\n"
//		   "\t\tproducer\tconsumer\tcached_prod\tcached_cons\n"
//		   "    FILL_RING   %d		%d		%d		%d\n"
//		   "    COMP_RING	%d		%d		%d		%d\n"
//		   "    RX_RING	%d		%d		%d		%d\n"
//		   "    TX_RING	%d		%d		%d		%d\n\n"
//			, *xsk->umem->fq.producer, *xsk->umem->fq.consumer, xsk->umem->fq.cached_prod, xsk->umem->fq.cached_cons
//			, *xsk->umem->cq.producer, *xsk->umem->cq.consumer, xsk->umem->cq.cached_prod, xsk->umem->cq.cached_cons
//			, *xsk->rx.producer, *xsk->rx.consumer, xsk->rx.cached_prod, xsk->rx.cached_cons
//			, *xsk->tx.producer, *xsk->tx.consumer, xsk->tx.cached_prod, xsk->tx.cached_cons);
